...
#define GNOME_SCREENSAVER_DBUS_NAME      "io.github.scarecrow_de.ScreenSaver"
#define GNOME_SCREENSAVER_DBUS_OBJECT    "/io/github/scarecrow_de/ScreenSaver"

#define GNOME_SHELL_DBUS_NAME      "io.github.scarecrow_de.Shell"
#define GNOME_SHELL_DBUS_OBJECT    "/io/github/scarecrow_de/Shell"
...
gnome_settings_bus_get_session_proxy (void)
{
        ...
        if (session_proxy != NULL) {
                ...
                session_proxy = scsd_session_manager_proxy_new_for_bus_sync (G_BUS_TYPE_SESSION,
...
gnome_settings_bus_get_screen_saver_proxy (void)
{
        ...
        if (screen_saver_proxy != NULL) {
                ...
                screen_saver_proxy = scsd_screen_saver_proxy_new_for_bus_sync (G_BUS_TYPE_SESSION,
...
gnome_settings_bus_get_shell_proxy (void)
{
        ...
        if (shell_proxy != NULL) {
                ...
                shell_proxy = scsd_shell_proxy_new_for_bus_sync (G_BUS_TYPE_SESSION,
								G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES |
								G_DBUS_PROXY_FLAGS_DO_NOT_AUTO_START,
