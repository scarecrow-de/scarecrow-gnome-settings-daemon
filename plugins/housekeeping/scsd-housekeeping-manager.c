...
/* Thumbnail cleaner */
#define THUMB_PREFIX "io.github.scarecrow_de.desktop.thumbnail-cache"

#define THUMB_AGE_KEY "maximum-age"
#define THUMB_SIZE_KEY "maximum-size"

#define GSD_HOUSEKEEPING_DBUS_PATH "/io/github/scarecrow_de/SettingsDaemon/Housekeeping"

static const gchar introspection_xml[] =
"<node>"
"  <interface name='io.github.scarecrow_de.SettingsDaemon.Housekeeping'>"
