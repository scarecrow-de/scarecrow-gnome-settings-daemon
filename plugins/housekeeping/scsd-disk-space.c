...
#define SETTINGS_HOUSEKEEPING_DIR     "io.github.scarecrow_de.settings-daemon.plugins.housekeeping"
             ...
             const char *mount_path)
{
        ...
        notify_notification_set_hint_string (notification, "desktop-entry", "io.github.scarecrow_de.baobab");
