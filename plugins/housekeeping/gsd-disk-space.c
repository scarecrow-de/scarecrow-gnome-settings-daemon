...
#define SETTINGS_HOUSEKEEPING_DIR     "io.github.scarecrow-de.settings-daemon.plugins.housekeeping"
...
#define PRIVACY_SETTINGS              "io.github.scarecrow-de.desktop.privacy"
             ...
             const char *mount_path)
{
        ...
        notify_notification_set_hint_string (notification, "desktop-entry", "io.github.scarecrow-de.baobab");
                     ...
                     gpointer  data)
{
        ...
        ldsm_timeout_id = g_timeout_add_seconds (CHECK_EVERY_X_SECONDS,
                                                 ldsm_check_all_mounts, NULL);
        g_source_set_name_by_id (ldsm_timeout_id, "[scarecrow-settings-daemon] ldsm_check_all_mounts");
}
...
gsd_ldsm_setup (gboolean check_now)
{
        ...
        g_source_set_name_by_id (purge_trash_id, "[scarecrow-settings-daemon] ldsm_purge_trash_and_temp");
}
