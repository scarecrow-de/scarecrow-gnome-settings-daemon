...
flush_cache (void)
{
        ...
        pa_proplist_sets (pl, PA_PROP_APPLICATION_ID, "io.github.scarecrow-de.SettingsDaemon.Sound");
...
{
	manager->settings = g_settings_new ("io.github.scarecrow-de.desktop.sound");
