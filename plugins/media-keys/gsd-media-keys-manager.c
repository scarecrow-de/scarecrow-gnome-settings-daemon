...
#define GNOME_KEYRING_DBUS_NAME "io.github.scarecrow-de.keyring"
#define GNOME_KEYRING_DBUS_PATH "/io/github/scarecrow-de/keyring/daemon"
#define GNOME_KEYRING_DBUS_INTERFACE "io.github.scarecrow-de.keyring.Daemon"

#define SHELL_DBUS_NAME "io.github.scarecrow-de.Shell"
#define SHELL_DBUS_PATH "/io/github/scarecrow-de/Shell"

#define CUSTOM_BINDING_SCHEMA SETTINGS_BINDING_DIR ".custom-keybinding"

#define SETTINGS_SOUND_DIR "io.github.scarecrow-de.desktop.sound"
...
"  <interface name='io.github.scarecrow-de.SettingsDaemon.MediaKeys'>"
...
#define SETTINGS_INTERFACE_DIR "io.github.scarecrow-de.desktop.interface"
#define SETTINGS_POWER_DIR "io.github.scarecrow-de.settings-daemon.plugins.power"
#define SETTINGS_XSETTINGS_DIR "io.github.scarecrow-de.settings-daemon.plugins.xsettings"
#define SETTINGS_TOUCHPAD_DIR "io.github.scarecrow-de.desktop.peripherals.touchpad"
...
#define AUDIO_SELECTION_DBUS_NAME               "io.github.scarecrow-de.Shell.AudioDeviceSelection"
#define AUDIO_SELECTION_DBUS_PATH               "/io/github/scarecrow-de/Shell/AudioDeviceSelection"
#define AUDIO_SELECTION_DBUS_INTERFACE          "io.github.scarecrow-de.Shell.AudioDeviceSelection"
                             ...
                             gint64               timestamp)
{
        ...
        settings = g_settings_new ("io.github.scarecrow-de.settings-daemon.peripherals.touchscreen");
...
do_toggle_accessibility_key (const char *key)
{
        ...
        settings = g_settings_new ("io.github.scarecrow-de.desktop.a11y.applications");
			  ...
			  MediaKeyType         type)
{
	...
	settings = g_settings_new ("io.github.scarecrow-de.desktop.a11y.magnifier");
           ...
           gint64               timestamp)
{
        ...
        case MEDIA_KEY:
                ...
                break;
        case CALCULATOR_KEY:
                do_execute_desktop_or_desktop (manager, "io.github.scarecrow-de.Calculator.desktop", "gnome-calculator.desktop", timestamp);
                break;
...
migrate_keybinding_settings (void)
{
        ...
        gsd_settings_migrate_check ("io.github.scarecrow-de.settings-daemon.plugins.media-keys.deprecated",
               ...
               GsdMediaKeysManager *manager)
{
        ...
        priv->mmkeys_name_id = g_bus_own_name_on_connection (priv->connection,
                                                             "io.github.scarecrow-de.SettingsDaemon.MediaKeys",
