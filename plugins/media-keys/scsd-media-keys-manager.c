...
#define GNOME_KEYRING_DBUS_NAME "io.github.scarecrow_de.keyring"
#define GNOME_KEYRING_DBUS_PATH "/io/github/scarecrow_de/keyring/daemon"
#define GNOME_KEYRING_DBUS_INTERFACE "io.github.scarecrow_de.keyring.Daemon"

#define SHELL_DBUS_NAME "io.github.scarecrow_de.Shell"
#define SHELL_DBUS_PATH "/io/github/scarecrow_de/Shell"
...
#define AUDIO_SELECTION_DBUS_NAME               "io.github.scarecrow_de.Shell.AudioDeviceSelection"
                             ...
                             gint64               timestamp)
{
        ...
        settings = g_settings_new ("io.github.scarecrow_de.settings-daemon.peripherals.touchscreen");
           ...
           gint64               timestamp)
{
        ...
        case MEDIA_KEY:
                ...
                break;
        case CALCULATOR_KEY:
                do_execute_desktop_or_desktop (manager, "io.github.scarecrow_de.Calculator.desktop", "gnome-calculator.desktop", timestamp);
                break;
...
migrate_keybinding_settings (void)
{
        ...
        gsd_settings_migrate_check ("io.github.scarecrow_de.settings-daemon.plugins.media-keys.deprecated",
