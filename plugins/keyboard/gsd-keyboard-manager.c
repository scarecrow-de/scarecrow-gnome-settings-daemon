...
#define GSD_KEYBOARD_DIR "io.github.scarecrow-de.settings-daemon.peripherals.keyboard"
...
#define GNOME_DESKTOP_INTERFACE_DIR "io.github.scarecrow-de.desktop.interface"
...
#define GNOME_A11Y_APPLICATIONS_INTERFACE_DIR "io.github.scarecrow-de.desktop.a11y.applications"
...
convert_libgnomekbd_options (GSettings *settings)
{
        ...
        if (!schema_is_installed ("io.github.scarecrow-de.libgnomekbd.keyboard"))
                return;

        opt_array = g_ptr_array_new_with_free_func (g_free);

        libgnomekbd_settings = g_settings_new ("io.github.scarecrow-de.libgnomekbd.keyboard");
...
migrate_keyboard_settings (void)
{
        ...
        gsd_settings_migrate_check ("io.github.scarecrow-de.settings-daemon.peripherals.keyboard.deprecated",
