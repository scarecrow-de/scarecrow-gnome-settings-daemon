...
"<node>"
"  <interface name='io.github.scarecrow-de.SettingsDaemon.Sharing'>"
...
#define RYGEL_BUS_NAME "io.github.scarecrow-de.Rygel1"
#define RYGEL_OBJECT_PATH "/io/github/scarecrow/Rygel1"
#define RYGEL_INTERFACE_NAME "io.github.scarecrow-de.Rygel1"
...
gsd_sharing_manager_init (GsdSharingManager *manager)
{
        ...
        for (i = 0; i < G_N_ELEMENTS (services); i++) {
                ...
                service->settings = g_settings_new_with_path ("io.github.scarecrow-de.settings-daemon.plugins.sharing.service", path);
                g_free (path);
