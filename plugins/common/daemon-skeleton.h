...
#define GNOME_SESSION_CLIENT_PRIVATE_DBUS_INTERFACE "io.github.scarecrow.SessionManager.ClientPrivate"
...
main (int argc, char **argv)
{
	...
	if (timeout > 0) {
		...
		g_source_set_name_by_id (id, "[scarecrow-settings-daemon] g_main_loop_quit");
	}
