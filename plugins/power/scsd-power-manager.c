...
#define GSD_POWER_SETTINGS_SCHEMA               "io.github.scarecrow_de.settings-daemon.plugins.power"
...
"<node>"
"  <interface name='io.github.scarecrow_de.SettingsDaemon.Power.Screen'>"
...
"    </method>"
"  </interface>"
"  <interface name='io.github.scarecrow_de.SettingsDaemon.Power.Keyboard'>"
"    <property name='Brightness' type='i' access='readwrite'/>"
"    <method name='StepUp'>"
"      <arg type='i' name='new_percentage' direction='out'/>"
"    </method>"
                      ...
                      guint            logout_mode)
{
        if (g_getenv ("RUNNING_UNDER_GDM")) {
                g_warning ("Prevented logout from GDM session! This indicates an issue in scsd-power.");
                return;
        }
                           ...
                           GDBusMethodInvocation *invocation)
{
        ...
        g_object_set_data_full (G_OBJECT (invocation), "scsd-power-manager", g_object_ref (manager), g_object_unref);
