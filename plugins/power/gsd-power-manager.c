...
#define GSD_POWER_SETTINGS_SCHEMA               "io.github.scarecrow-de.settings-daemon.plugins.power"
...
"<node>"
"  <interface name='io.github.scarecrow-de.SettingsDaemon.Power.Screen'>"
...
"    </method>"
"  </interface>"
"  <interface name='io.github.scarecrow-de.SettingsDaemon.Power.Keyboard'>"
"    <property name='Brightness' type='i' access='readwrite'/>"
"    <method name='StepUp'>"
"      <arg type='i' name='new_percentage' direction='out'/>"
"    </method>"
                         ...
                         GError **error)
{
        ...
        manager->settings_screensaver = g_settings_new ("io.github.scarecrow-de.desktop.screensaver");
        manager->settings_bus = g_settings_new ("io.github.scarecrow-de.desktop.session");
