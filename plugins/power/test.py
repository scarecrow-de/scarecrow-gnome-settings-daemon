...
class PowerPluginBase(gsdtestcase.GSDTestCase):
    ...
    def setUp(self):
        ...
        self.obj_session_mgr = self.session_bus_con.get_object(
            'io.github.scarecrow-de.SessionManager', '/io/github/scarecrow/SessionManager')

        self.start_mutter()

        # Set up the gnome-session presence
        obj_session_presence = self.session_bus_con.get_object(
            'io.github.scarecrow-de.SessionManager', '/io/github/scarecrow/SessionManager/Presence')
        ...
        # gets active
        self.settings_screensaver = Gio.Settings(schema_id='io.github.scarecrow-de.desktop.screensaver')
        ...
        self.settings_gsd_power = Gio.Settings(schema_id='io.github.scarecrow-de.settings-daemon.plugins.power')
    ...
    def get_status(self):
        return self.obj_session_presence_props.Get('io.github.scarecrow-de.SessionManager.Presence', 'status')
...
class PowerPluginTest1(PowerPluginBase):
    ...
    def test_sleep_inactive_blank(self):
        ...
        inhibit_id = self.obj_session_mgr.Inhibit(
            ...
            dbus_interface='io.github.scarecrow-de.SessionManager')
...
class PowerPluginTest7(PowerPluginBase):
    def test_check_missing_kbd_brightness(self):
        ...
        obj_gsd_power_kbd = self.session_bus_con.get_object(
            'io.github.scarecrow-de.SettingsDaemon.Power', '/io.github.scarecrow-de.SettingsDaemon/Power')
        ...
        with self.assertRaises(dbus.DBusException) as exc:
            kbd_brightness = obj_gsd_power_kbd_props.Get('io.github.scarecrow-de.SettingsDaemon.Power.Keyboard', 'Brightness')
        ...
        self.assertEqual(exc.exception.get_dbus_message(), 'Failed to get property Brightness on interface io.github.scarecrow-de.SettingsDaemon.Power.Keyboard')
...
class PowerPluginTest8(PowerPluginBase):
    def test_brightness_stepping(self):
        ...
        obj_gsd_power = self.session_bus_con.get_object(
            'io.github.scarecrow-de.SettingsDaemon.Power', '/io.github.scarecrow-de.SettingsDaemon/Power')
        obj_gsd_power_screen_iface = dbus.Interface(obj_gsd_power, 'io.github.scarecrow-de.SettingsDaemon.Power.Screen')
    ...
    def test_brightness_compression(self):
        ...
        for brightness in range(70, 91):
            obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', brightness)
    ...
    def test_brightness_uevent(self):
        ...
        brightness = obj_gsd_power_prop_iface.Get('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness')
    ...
    def test_legacy_brightness_rounding(self):
        ...
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 0)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 0)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 10)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 2)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 20)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 3)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 25)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 4)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 49)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 7)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 50)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 8)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 56)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 8)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 57)
        time.sleep(0.4)
        self.assertEqual(self.get_brightness(), 9)
        obj_gsd_power_prop_iface.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 98)
        time.sleep(0.4)
    ...
    def test_no_backlight(self):
        ...
        obj_gsd_power_screen = dbus.Interface(obj_gsd_power, 'io.github.scarecrow-de.SettingsDaemon.Power.Screen')

        # We expect -1 to be returned
        brightness = obj_gsd_power_props.Get('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness')
        self.assertEqual(brightness, -1)

        # Trying to set the brightness
        with self.assertRaises(dbus.DBusException) as exc:
            obj_gsd_power_props.Set('io.github.scarecrow-de.SettingsDaemon.Power.Screen', 'Brightness', 1)
